...
public class TeacherService {
    ...
    private final GradesRespository gradesRespository;

    public TeacherService(TeacherRepository teacherRepository, StudentRepository studentRepository, GradesRespository gradesRespository) {
